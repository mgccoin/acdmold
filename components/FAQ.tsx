      ...
      <div className="container-prose">
        <div className="grid gap-10 lg:grid-cols-12">
          <div className="lg:col-span-4">
            ...
            <h2 id="faq-heading" className="h-sectionTitle mt-2">{title}</h2>
            ...
            >
              {items.map((item, i) => (
                ...
                >
                  ...
                  >
                    <span className="faq-question font-semibold text-brand-900" itemProp="name">
                      {item.q}
                    </span>
                    <ChevronDown
                  ...
                  {open === i && (
                    <div
                      className="faq-answer px-6 pb-5 text-sm leading-relaxed text-slate-700"
                      itemScope
